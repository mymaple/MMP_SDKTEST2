#
#  Be sure to run `pod spec lint MMP-SDKTEST.podspec' to ensure this is a
...
SDK说明：SDK支持的系统最低要求是iOS 8.0，只支持真机架构(arm64和armv7)，不支持模拟器架构(x86_64和i386)。
  ...
  spec.homepage     = "https://github.com/mymaple/MMP_SDKTEST2"	# 项目主页
  ...
  spec.source       = { :git => "https://github.com/mymaple/MMP_SDKTEST2.git", :tag => "#{spec.version}" }
